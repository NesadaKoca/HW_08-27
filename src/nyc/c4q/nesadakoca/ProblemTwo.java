package nyc.c4q.nesadakoca;

/**
 * Created by nesadakoca on 8/28/16.
 */
/**Write a method named calculateAge that takes two arguments: birth year and current year.
 * The method should then calculate the two possible ages based on that year, and return the result in the following format:
